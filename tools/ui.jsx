...
export default function App() {
  ...
  if (typeof window.ethereum === "undefined") {
    return (
      ...
      >
        <h1 style={{ textAlign: "center" }}>Replit 🤝 Devfolio</h1>
        <a
...
function ReplitFaucetLink({ walletAddress }) {
  ...
  async function getEther(e) {
    window.open("https://faucet.polygon.technology/", "__blank");
  }
          ...
          <HelpIndicator
            text={
              chainId === 1
                ...
                : "You are connected to a test network. Test networks let you deploy your contracts with fake MATIC"
            }
          />
        </span>
      </HStack>
